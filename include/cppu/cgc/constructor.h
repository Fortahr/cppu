...
namespace cppu
{
	namespace cgc
	{
		...
		template<typename, typename, bool> class array;
		template<typename, typename, bool> class vector;
		...
		template<typename, typename, bool> class unordered_map;
		...
		{
			// friends
			template<typename, typename, bool> friend class array;
			...
			template<typename, typename, bool> friend class unordered_map;

			template<typename, typename, bool> friend class ref::array;
			template<typename, typename, bool> friend class ref::vector;
			...
			template<typename, typename, bool> friend class ref::unordered_map;
